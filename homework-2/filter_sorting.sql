...
SELECT MIN(unit_price) as min_unit_price, MAX(unit_price) as max_unit_price FROM products WHERE discontinued != 1
...
SELECT MIN(unit_price) as min_unit_price, MAX(unit_price) as max_unit_price FROM products WHERE discontinued != 1 AND units_in_stock >= 20